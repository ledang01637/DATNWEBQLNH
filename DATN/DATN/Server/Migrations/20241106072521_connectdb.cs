...
{
<<<<<<<< HEAD:DATN/DATN/Server/Migrations/20241023140535_v1.cs
    public partial class v1 : Migration
========
    public partial class connectdb : Migration
>>>>>>>> cdfdc77 (Fix lỗi không chọn được các năm có trong DB):DATN/DATN/Server/Migrations/20241106072521_connectdb.cs
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Password = table.Column<string>(type: "char(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VoucherId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VoucherCode = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Message_Tables_TableId",
                        column: x => x.TableId,
